...
const StayProductive = () => {
  return (
    <div className="my-20 grid items-center gap-12 p-7 md:my-[8.5rem] md:grid-cols-2 md:gap-14 md:px-[6.5rem]">
      <div>
        <img
          src={illustration}
          alt="illustration"
      ...
      <div className="space-y-4 md:space-y-6">
        <h2 className="font-Raleway text-lg font-bold md:text-[2.5rem] md:leading-snug">
          <span className="md:block">Stay productive,</span> wherever you are
        </h2>
